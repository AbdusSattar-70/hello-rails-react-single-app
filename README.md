...
This serves as the initial venture into the world of combining Rails, React, and Redux for learning purposes.
...
```sh
  ...
  https://github.com/AbdusSattar-70/hello-rails-react.git
```
...
Feel free to check the [issues page](https://github.com/AbdusSattar-70/hello-rails-react/issues).
